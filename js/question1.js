...
<div class="subtitle-copy">
  ...
  <button value="sound" onclick="window.location.href='checkindex.html'; "id="ce" class="btn btn-primary">Next Test</button>
  <button value="sound" onclick="window.location.href='./pages/locate.html'; "id="ce" class="btn btn-primary">Nearby Centre</button>
  </span>
  </p>
